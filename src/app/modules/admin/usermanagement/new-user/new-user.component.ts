...
import { Tag, Country,Contact } from '../../apps/contacts/contacts.types';
...
@Component({
  ...
  imports        : [FuseFindByKeyPipe,NgIf, MatButtonModule, MatTooltipModule, RouterLink, MatIconModule, NgFor, FormsModule, ReactiveFormsModule, MatRippleModule, MatFormFieldModule, MatInputModule, MatCheckboxModule, NgClass, MatSelectModule, MatOptionModule, MatDatepickerModule, TextFieldModule, DatePipe],
})
...
formFieldHelpers: any;
  ...
  constructor(private _usersListComponent: ListUsersComponent,
    ...
    updateContact(): void
    {
        ...
        this._contactsService.createUser(contact).subscribe(() =>
        {
            // Toggle the edit mode off
            this.toggleEditMode(false);
        });
